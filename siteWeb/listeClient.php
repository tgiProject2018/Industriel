...
<?php
   ...
   /* // On inclus notre fichier de connexion � la bdo
    // =============================================================================================
    ...
    // On fait certain si le user est deja login de le redirect tout de suite � sign out
    // =============================================================================================
    ...
    // On recoit la requ�te (le login)
    // =============================================================================================
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        
        // Le username et password d'entr�
        // *****************************************************************************************
        ...
        // Les donn�es entr�es par le user etait pas bonne
        // *****************************************************************************************
        else {
          $error = "Vos donn�es entr�es sont invalides.";
          echo "<script type='text/javascript'>alert('Donn�es Invalides');</script>";
        }
        // *****************************************************************************************
    }
   */ // =============================================================================================
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item px-lg-2">
            <a class="nav-link text-uppercase text-expanded" href="echeancier.html">Échéancier
            </a>
          </li>
          <li class="nav-item px-lg-2">
